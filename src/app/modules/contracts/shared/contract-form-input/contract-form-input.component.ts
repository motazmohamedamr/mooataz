...
@Component({
  selector: 'app-contract-form-input',
  templateUrl: './contract-form-input.component.html',
  styleUrl: './contract-form-input.component.scss',
  providers: [
    { provide: NG_VALUE_ACCESSOR, useExisting: ContractFormInputComponent, multi: true },
    {
      provide: NG_VALIDATORS,
      useExisting: ContractFormInputComponent,
      multi: true,
    },
  ],
})
export class ContractFormInputComponent
