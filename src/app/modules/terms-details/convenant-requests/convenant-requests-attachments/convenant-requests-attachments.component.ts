...
@Component({
  selector: 'app-convenant-requests-attachments',
  templateUrl: './convenant-requests-attachments.component.html',
  styleUrl: './convenant-requests-attachments.component.scss',
})
export class ConvenantRequestsAttachmentsComponent implements OnChanges {
